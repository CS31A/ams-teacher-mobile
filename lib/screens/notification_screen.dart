...
class _NotificationScreenState extends State<NotificationScreen> {
  final List<NotificationItem> _notifications = [
    ...
    NotificationItem(
      ...
      message: 'Assignment submission from Olivia Brown',
      time: DateTime.now().subtract(const Duration(hours: 5)),
      type: NotificationType.email,
      isRead: false,
      emailData: EmailMessage(
        id: 'email_3',
        from: 'olivia.brown@school.edu',
        fromName: 'Olivia Brown',
        subject: 'Assignment Submission - Math Homework',
        body: 'Dear Teacher,\n\nI have completed my math homework assignment and attached it to this email. I apologize for the slight delay in submission.\n\nPlease let me know if you need any clarification on my work.\n\nThank you,\nOlivia Brown',
        receivedAt: DateTime.now().subtract(const Duration(hours: 5)),
        priority: 'Normal',
        attachments: ['math_homework_olivia.pdf'],
        studentId: 'STU003',
    ...
    NotificationItem(
      ...
      message: 'Question about upcoming test from Noah Davis',
      time: DateTime.now().subtract(const Duration(hours: 6)),
      type: NotificationType.email,
      isRead: true,
      emailData: EmailMessage(
        id: 'email_4',
        from: 'noah.davis@school.edu',
        fromName: 'Noah Davis',
        subject: 'Question about Science Test',
        body: 'Hi Teacher,\n\nI have a question about the upcoming science test. Could you please clarify what topics will be covered in Chapter 7?\n\nAlso, will we need to memorize all the formulas or will they be provided?\n\nThank you for your help!\n\nBest regards,\nNoah Davis',
    ...
    NotificationItem(
      ...
      message: 'Extra credit request from Ava Wilson',
      time: DateTime.now().subtract(const Duration(hours: 8)),
      type: NotificationType.email,
      isRead: true,
      emailData: EmailMessage(
        id: 'email_5',
        from: 'ava.wilson@school.edu',
        fromName: 'Ava Wilson',
        subject: 'Extra Credit Opportunity Request',
        body: 'Dear Teacher,\n\nI hope you are doing well. I was wondering if there are any extra credit opportunities available for this semester?\n\nI would like to improve my grade and am willing to put in the extra effort. Please let me know if there are any projects or assignments I can work on.\n\nThank you for considering my request.\n\nSincerely,\nAva Wilson',
